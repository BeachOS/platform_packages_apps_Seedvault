package org.beachos.backup.storage
...
import org.beachos.backup.storage.api.SnapshotResult
import org.beachos.backup.storage.api.StoragePlugin
import org.beachos.backup.storage.api.StoredSnapshot
import org.beachos.backup.storage.backup.Backup
import org.beachos.backup.storage.backup.Backup.Companion.CHUNK_SIZE_MAX
import org.beachos.backup.storage.backup.Backup.Companion.SMALL_FILE_SIZE_MAX
import org.beachos.backup.storage.backup.BackupMediaFile
import org.beachos.backup.storage.backup.BackupSnapshot
import org.beachos.backup.storage.backup.ChunksCacheRepopulater
import org.beachos.backup.storage.content.ContentFile
import org.beachos.backup.storage.content.DocFile
import org.beachos.backup.storage.content.MediaFile
import org.beachos.backup.storage.crypto.Hkdf.ALGORITHM_HMAC
import org.beachos.backup.storage.crypto.Hkdf.KEY_SIZE_BYTES
import org.beachos.backup.storage.db.CachedChunk
import org.beachos.backup.storage.db.CachedFile
import org.beachos.backup.storage.db.ChunksCache
import org.beachos.backup.storage.db.Db
import org.beachos.backup.storage.db.FilesCache
import org.beachos.backup.storage.plugin.SnapshotRetriever
import org.beachos.backup.storage.restore.FileRestore
import org.beachos.backup.storage.restore.RestorableFile
import org.beachos.backup.storage.restore.Restore
import org.beachos.backup.storage.scanner.FileScanner
import org.beachos.backup.storage.scanner.FileScannerResult
...
internal class BackupRestoreTest {
    ...
    init {
        ...
        mockkStatic("org.beachos.backup.storage.UriUtilsKt")
